...
flowchart TD
    ...
    A[Customer Channels] --> B[Enterprise Control Plane]
    B --> C[Multi-Rail Orchestration Engine]
    B --> D[Fraud/AML Intelligence]
    B --> E[Pricing & Entitlements]
